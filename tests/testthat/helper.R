 ...
 helper_addCohortAndCohortDefinitionTables <- function(cohortTableHandlerConfig, cohortTablesToAdd = "Diabetes"){
  ...
  if (cohortTablesToAdd == "Diabetes") {
    ...
    testCohortDefinitionTable <- tibble::tribble(
      ...
      1, 'Diabetes Cohort E [Endpoint]', 'Cohort of patients diagnosed with diabetes', 1234, 'SELECT * FROM patients WHERE diagnosis = "Diabetes"', 5678, as.Date('2022-01-01'),
      2, 'Hypertension Cohort E [Endpoint]', 'Cohort of patients diagnosed with hypertension', 1234, 'SELECT * FROM patients WHERE diagnosis = "Hypertension"', 5678, as.Date('2022-01-01'),
      3, 'Obesity Cohort E [Endpoint]', 'Cohort of patients diagnosed with obesity', 1234, 'SELECT * FROM patients WHERE diagnosis = "Obesity"', 5678, as.Date('2022-01-01'),
      #
